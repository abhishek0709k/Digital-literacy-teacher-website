document.addEventListener("DOMContentLoaded", function () {
    ...
    const quickQuestions = document.querySelectorAll(".quick-reply");
    ...
    function formatStepsResponse(steps, header, video) {
    ...
    function addMessage(message, sender) {
      ...
      // Create a temporary container to decode HTML entities
      const temp = document.createElement("div");
      temp.innerHTML = message;
  
      // Clone the nodes to avoid security issues
